...
const (
	Auth_UserAuth_FullMethodName = "/github.com.mashmorsik.rand.quote.grpc.v1.Auth/UserAuth"
)
...
func (c *authClient) UserAuth(ctx context.Context, in *UserAuthRequest, opts ...grpc.CallOption) (*UserAuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_UserAuth_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.mashmorsik.rand.quote.grpc.v1.Auth",
